...
class HomeController extends Controller
{
  public function index(Request $request)
  {
    ...
    $categories = ListingCategory::withCount('listing_contents')->where('language_id', $language->id)->where('status', 1)->orderBy('serial_number', 'asc')->get();
    ...
    //product fetch
     $products = Product::join('product_contents', 'products.id', '=', 'product_contents.product_id')
        ...
        ->limit(10) // jitne products dikhane hain utna limit laga do
        ->get();
