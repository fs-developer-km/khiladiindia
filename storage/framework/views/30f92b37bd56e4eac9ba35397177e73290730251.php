  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="<?php echo e(route('admin.advertise.update_advertisement')); ?>"
          ...
          <div class="form-group">
            ...
            <select name="resolution_type" class="form-control" id="in_resolution_type">
              ...
              <option value="1"><?php echo e(__('300 x 250')); ?></option>
              <option value="2"><?php echo e(__('300 x 600')); ?></option>
              <option value="3"><?php echo e(__('728 x 90')); ?></option>
            </select>
          ...
          <div class="form-group d-none" id="edit-slot-input">
            ...
            <p class="mt-2 mb-0">
              <a href="//prnt.sc/1uwa420" target="_blank" class="redirect-link"><?php echo e(__('Click Here')); ?></a>
              <?php echo e(__('to see where you can find the ad slot') . '.'); ?>
...
<?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/advertisement/edit.blade.php ENDPATH**/ ?>