  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner">
    <div class="sidebar-content">
      ...
      <ul class="nav nav-primary">
        ...
        <li
          class="nav-item <?php if(request()->routeIs('vendor.listing_management.listing')): ?> active 
           <?php elseif(request()->routeIs('vendor.listing_management.create_listing')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.listing.products')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.listing.faq')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.listing.business_hours')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.listing.plugins')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.manage_additional_specifications')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.manage_social_link')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.create_Product')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.edit_product')): ?> active 
            <?php elseif(request()->routeIs('vendor.listing_management.edit_listing')): ?> active <?php endif; ?>">
          ...
          <div id="listingManagement"
            class="collapse 
              <?php if(request()->routeIs('vendor.listing_management.listing')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.create_listing')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.listing.products')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.listing.faq')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.listing.business_hours')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.listing.plugins')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.create_Product')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.manage_additional_specifications')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.manage_social_link')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.edit_product')): ?> show 
              <?php elseif(request()->routeIs('vendor.listing_management.edit_listing')): ?> show <?php endif; ?>">
            <ul class="nav nav-collapse">
              ...
              <li
                class=" <?php if(request()->routeIs('vendor.listing_management.listing')): ?> active
                   <?php elseif(request()->routeIs('vendor.listing_management.edit_listing')): ?> active 
                   <?php elseif(request()->routeIs('vendor.listing_management.listing.products')): ?> active 
                   <?php elseif(request()->routeIs('vendor.listing_management.listing.business_hours')): ?> active 
                   <?php elseif(request()->routeIs('vendor.listing_management.listing.faq')): ?> active 
                   <?php elseif(request()->routeIs('vendor.listing_management.listing.plugins')): ?> active 
                   ...
                   <?php elseif(request()->routeIs('vendor.listing_management.manage_social_link')): ?> active 
                   <?php elseif(request()->routeIs('vendor.listing_management.manage_additional_specifications')): ?> active 
                   <?php elseif(request()->routeIs('vendor.listing_management.edit_product')): ?> active <?php endif; ?>">
...
<?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/vendors/partials/side-navbar.blade.php ENDPATH**/ ?>