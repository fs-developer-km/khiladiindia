...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if(session()->has('showOtpField')): ?>
          <input type="text" class="form-control" name="otp"
                 placeholder="Currently you can use '12345'" required>
          <?php $__errorArgs = ['otp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <button type="submit" class="btn btn-primary w-100">
          <?php echo e(session()->has('showOtpField') ? 'Verify OTP & Login' : 'Send OTP'); ?>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/frontend/user/login.blade.php ENDPATH**/ ?>