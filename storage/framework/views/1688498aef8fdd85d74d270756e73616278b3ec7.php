        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-6 offset-lg-2">
              ...
              <a href="<?php echo e(route('admin.user_management.mail_for_subscribers')); ?>" class="btn btn-primary btn-sm float-right ml-3 mt-1 mb-1">
              ...
              <form class="float-right" action="<?php echo e(route('admin.user_management.subscribers')); ?>" method="GET">
                <input name="email" type="text" class="form-control minw-230" placeholder="Search By Email ID" value="<?php echo e(!empty(request()->input('email')) ? request()->input('email') : ''); ?>">
              </form>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <?php if(count($subscribers) == 0): ?>
                <h3 class="text-center mt-2"><?php echo e(__('NO SUBSCRIBER FOUND') . '!'); ?></h3>
              <?php else: ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/end-user/subscriber/index.blade.php ENDPATH**/ ?>