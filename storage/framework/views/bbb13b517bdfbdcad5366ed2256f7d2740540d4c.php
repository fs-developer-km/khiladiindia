...
<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
          <div class="col-12">
            <div class="section-title title-inline mb-30" data-aos="fade-up">
              <h2 class="title mb-20"><?php echo e(@$workProcessSecInfo->title); ?></h2>
            </div>
          </div>
          <div class="col-12">
                  ...
                  <div class="card radius-lg mb-25">
                    <div class="card-content radius-md">
                      <div class="card-step h3"><span
                          data-hover="0<?php echo e($process->serial_number); ?>">0<?php echo e($process->serial_number); ?></span>
                      </div>
                      <div class="card-icon radius-md">
                        <i class="<?php echo e($process->icon); ?>"></i>
                      </div>
                      <h3 class="card-title m-0"><?php echo e($process->title); ?></h3>
                    </div>
                  </div>
                </div>
  ...
  <?php if($secInfo->counter_section_status == 1): ?>
    <div class="counter-area pt-100 pb-70">
      <!-- Background Image -->
      <img class="lazyload blur-up bg-img" src="<?php echo e(asset('assets/img/' . $counterSectionImage)); ?>" alt="Bg-img">
      <div class="overlay opacity-65"></div>
      <div class="container">
        <div class="section-title title-center mb-50" data-aos="fade-up">
          <h2 class="title color-white mb-0"><?php echo e($counterSectionInfo ? $counterSectionInfo->title : ''); ?></h2>
        </div>
            ...
            <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="150">
              <div class="card mb-30">
                <div class="d-flex align-items-center">
                  <div class="card-icon color-white"><i class="<?php echo e($counter->icon); ?>"></i></div>
                  <div class="card-content">
                    <h2 class="mb-1 color-white"><span class="counter"><?php echo e($counter->amount); ?></span>+
                    </h2>
                    <p class="card-text font-lg color-white"><?php echo e($counter->title); ?></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row align-items-center">
                      ...
                      <div class="client-info d-flex align-items-center">
                        <div class="client-img">
                          <div class="lazy-container rounded-pill ratio ratio-1-1">
                            <img class="lazyload" src="<?php echo e(asset('assets/img/clients/' . $testimonial->image)); ?>"
                              alt="Person Image">
                          </div>
                        </div>
                        <div class="content">
          ...
          <div class="col-lg-4">
            <div class="img-content mb-40" data-aos="fade-left">
              <div class="img">
                <img class="lazyload blur-up" src="<?php echo e(asset('assets/img/' . $testimonialSecImage)); ?>" alt="Image">
              </div>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/frontend/about.blade.php ENDPATH**/ ?>