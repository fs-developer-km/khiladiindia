<?php $__env->startSection('content'); ?>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="<?php echo e(route('vendor.listing.message.bulk_delete.message')); ?>"><i class="flaticon-interface-5"></i>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="<?php echo e(route('vendor.listing.message.delete_message')); ?>"method="post">
                              <?php echo csrf_field(); ?>
  ...
  <?php echo $__env->make('vendors.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('vendors.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/vendors/message/listing.blade.php ENDPATH**/ ?>