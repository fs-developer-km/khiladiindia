<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    ...
    <div class="col-lg-4">
      <div class="card">
        <form class="" action="<?php echo e(route('admin.payment_gateways.update_anet_info')); ?>" method="post">
          <?php echo csrf_field(); ?>
          <div class="card-header">
            <div class="row">
              <div class="col-lg-12">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/payment-gateways/online-gateways.blade.php ENDPATH**/ ?>