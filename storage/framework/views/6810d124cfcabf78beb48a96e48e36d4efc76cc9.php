                ...
                <div id="recurringBilling">
                  <div class="form-group">
                    ...
                    <p class="text-warning mb-0">
                      <?php echo e(__('Specify how many days before you want to remind your customers about subscription expiration. (via mail)')); ?>

                    </p>
                    <?php $__errorArgs = ['expiration_reminder'];
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/packages/settings.blade.php ENDPATH**/ ?>