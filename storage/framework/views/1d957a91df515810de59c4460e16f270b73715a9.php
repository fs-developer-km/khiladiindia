            ...
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxForm" action="<?php echo e(route('admin.basic_settings.update_cookie_alert', ['language' => request()->input('language')])); ?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="cookie_alert_text" rows="4"><?php echo e($data != null ? $data->cookie_alert_text : ''); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/khiladi.electride.taxi/resources/views/admin/basic-settings/cookie-alert.blade.php ENDPATH**/ ?>