  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('Edit Amenitie')); ?></h5>
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="<?php echo e(route('admin.listing_specification.update_aminite')); ?>"
          method="post">
          <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/amenitie/edit.blade.php ENDPATH**/ ?>