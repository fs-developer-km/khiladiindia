...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              <div class="card-title d-inline-block"><?php echo e(__('Product Categories')); ?></div>
            </div>
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="<?php echo e(route('admin.shop_management.product.bulk_delete_category')); ?>">
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mt-1 mr-1 editBtn" href="#" data-toggle="modal"
                              ...
                              data-status="<?php echo e($category->status); ?>" data-serial_number="<?php echo e($category->serial_number); ?>">
                            ...
                            <form class="deleteForm d-inline-block"
                              action="<?php echo e(route('admin.shop_management.product.delete_category', ['id' => $category->id])); ?>"
                              method="post">
                              <?php echo csrf_field(); ?>
  ...
  <?php echo $__env->make('admin.shop.category.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

  
  <?php echo $__env->make('admin.shop.category.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/shop/category/index.blade.php ENDPATH**/ ?>