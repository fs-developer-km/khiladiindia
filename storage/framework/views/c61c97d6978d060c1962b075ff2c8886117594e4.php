      ...
      <div class="card">
        <form action="<?php echo e(route('admin.basic_settings.update_theme_and_home')); ?>" method="post"
          ...
          <div class="card-header">
            <div class="row">
              <div class="col-lg-10">
                <div class="card-title"><?php echo e(__('Theme & Home')); ?></div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-10 mx-auto">
                <h2 class="mt-3 text-warning"><?php echo e(__('Theme & Home')); ?></h2>
                <hr>
                    ...
                    <div class="col-md-3">
                      <label class="imagecheck">
                        <input name="theme_version" type="radio" value="1" class="imagecheck-input"
                          <?php echo e($data->theme_version == 1 ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-3">
                      <label class="imagecheck">
                        <input name="theme_version" type="radio" value="2" class="imagecheck-input"
                          <?php echo e($data->theme_version == 2 ? 'checked' : ''); ?>>
                        <figure class="imagecheck-figure">
                    ...
                    <div class="col-md-3">
                      <label class="imagecheck">
                        <input name="theme_version" type="radio" value="3" class="imagecheck-input"
                          <?php echo e($data->theme_version == 3 ? 'checked' : ''); ?>>
                        <figure class="imagecheck-figure">
                    ...
                    <div class="col-md-3">
                      <label class="imagecheck">
                        <input name="theme_version" type="radio" value="4" class="imagecheck-input"
                          <?php echo e($data->theme_version == 4 ? 'checked' : ''); ?>>
                        <figure class="imagecheck-figure">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/basic-settings/theme-&-home.blade.php ENDPATH**/ ?>