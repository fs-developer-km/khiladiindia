        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="ajaxEditForm" action="<?php echo e(route('admin.announcement_popups.update_popup', ['id' => $popup->id])); ?>"
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker ltr" name="end_date"
                          placeholder="Enter End Date" readonly autocomplete="off" value="<?php echo e($endDate); ?>">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control timepicker ltr" name="end_time"
                          placeholder="Enter End Time" readonly autocomplete="off" value="<?php echo e($endTime); ?>">
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control ltr" name="serial_number"
                        placeholder="Enter Serial Number" value="<?php echo e($popup->serial_number); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/popup/edit.blade.php ENDPATH**/ ?>