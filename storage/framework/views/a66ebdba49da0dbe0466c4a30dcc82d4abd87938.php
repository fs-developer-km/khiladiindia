          ...
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxEditForm"
                action="<?php echo e(route('admin.user_management.user.update_password', ['id' => $userInfo->id])); ?>"
                method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/end-user/user/change-password.blade.php ENDPATH**/ ?>