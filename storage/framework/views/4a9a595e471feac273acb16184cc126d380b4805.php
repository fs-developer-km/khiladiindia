              ...
              <div class="col-md-6">
                <div class="form-group mb-20">
                  <input type="email" name="email" class="form-control" id="email" required
                    data-error="Enter your email" value="<?php echo e(old('email')); ?>"
              ...
              <div class="col-md-12">
                <div class="form-group mb-20">
                  <input type="text" name="subject" value="<?php echo e(old('subject')); ?>" class="form-control" id=""
                    required placeholder="<?php echo e(__('Enter Email Subject')); ?>" />
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-12">
                <div class="form-group mb-20">
                  <textarea name="message" id="message"value="<?php echo e(old('message')); ?>" class="form-control" cols="30" rows="8"
                    required placeholder="<?php echo e(__('Write Your Message')); ?>"></textarea>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/frontend/contact.blade.php ENDPATH**/ ?>