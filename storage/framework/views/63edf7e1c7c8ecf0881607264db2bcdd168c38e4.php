<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form action="<?php echo e(route('vendor.update_mail_to_vendor')); ?>" method="post">
          <?php echo csrf_field(); ?>
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                <div class="alert alert-warning text-center" role="alert">
                  <strong
                    class="text-dark"><?php echo e(__('This mail address will be used to receive all mails from contact forms.')); ?></strong>
                </div>
...
<?php echo $__env->make('vendors.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/vendors/email/mail-to-admin.blade.php ENDPATH**/ ?>