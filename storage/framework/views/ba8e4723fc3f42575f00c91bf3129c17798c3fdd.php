    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col">
              <div class="card-title"><?php echo e(__('Update Video Section Image')); ?></div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              <form id="actionImgForm" action="<?php echo e(route('admin.home_page.update_video_section_image')); ?>" method="POST"
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <?php if(!empty($info->video_section_image)): ?>
                      <img src="<?php echo e(asset('assets/img/' . $info->video_section_image)); ?>" alt="image"
                        class="uploaded-img">
                    <?php else: ?>
                  ...
                  <?php $__errorArgs = ['video_section_image'];
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              <form id="actionForm"
                action="<?php echo e(route('admin.home_page.update_video_section', ['language' => request()->input('language')])); ?>"
                method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="button_name"
                        value="<?php echo e(empty($data->button_name) ? '' : $data->button_name); ?>"
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="url" class="form-control ltr" name="button_url"
                        value="<?php echo e(empty($data->button_url) ? '' : $data->button_url); ?>" placeholder="Enter Button URL">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="url" class="form-control ltr" name="video_url"
                        value="<?php echo e(empty($data->video_url) ? '' : $data->video_url); ?>" placeholder="Enter Video URL">
                    </div>
                  </div>
                </div>
              </form>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/home-page/video-section.blade.php ENDPATH**/ ?>