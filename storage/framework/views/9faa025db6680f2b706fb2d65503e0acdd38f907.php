<?php $__env->startSection('content'); ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary mt-1 btn-sm mr-1 editBtn" href="#" data-toggle="modal"
                              data-target="#editModal" data-id="<?php echo e($media->id); ?>" data-icon="<?php echo e($media->icon); ?>"
                              data-url="<?php echo e($media->url); ?>" data-serial_number="<?php echo e($media->serial_number); ?>">
  ...
  <?php echo $__env->make('admin.basic-settings.social-media.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

  
  <?php echo $__env->make('admin.basic-settings.social-media.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/basic-settings/social-media/index.blade.php ENDPATH**/ ?>