        ...
        <form id="ajaxForm" class="modal-form" action="<?php echo e(route('admin.basic_settings.store_social_media')); ?>" method="post">
          ...
          <div class="form-group">
            ...
            <div class="text-warning mt-2">
              <small><?php echo e(__('Click on the dropdown icon to select a icon.')); ?></small>
            </div>
          </div>
...
<?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/basic-settings/social-media/create.blade.php ENDPATH**/ ?>