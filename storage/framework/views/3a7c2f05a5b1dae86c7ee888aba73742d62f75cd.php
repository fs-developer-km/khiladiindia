    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create"
          action="<?php echo e(route('admin.shop_management.product.store_category')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/shop/category/create.blade.php ENDPATH**/ ?>