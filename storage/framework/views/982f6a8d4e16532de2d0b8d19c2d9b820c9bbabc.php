<?php $__env->startSection('content'); ?>
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#"><?php echo e(__('Product Messages')); ?></a>
      </li>
    </ul>
  </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="<?php echo e(route('admin.product.message.bulk_delete.message')); ?>"><i class="flaticon-interface-5"></i>
                  ...
                  <table class="table table-striped mt-3" id="basic-datatables">
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><?php echo e(__('Product Title')); ?></th>
                    ...
                    <tbody>
                      <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <?php
                            $product_content = App\Models\Listing\ListingProductContent::where(
                                'listing_product_id',
                                $message->product_id,
                            )
                            ...
                            $listing_content = App\Models\Listing\ListingContent::where([
                                ['listing_id', @$product_content->listing_id],
                          ...
                          <td>
                            <?php if(!empty($product_content)): ?>
                              <?php echo e(strlen($product_content->title) > 40 ? mb_substr($product_content->title, 0, 40, 'utf-8') . '...' : $product_content->title); ?>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="<?php echo e(route('admin.product.message.delete_message')); ?>"method="post">
                              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/message/product.blade.php ENDPATH**/ ?>