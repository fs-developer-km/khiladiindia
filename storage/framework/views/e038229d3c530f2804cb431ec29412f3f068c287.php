...
<?php $__env->startSection('content'); ?>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="<?php echo e(route('admin.listing_specification.bulk_delete_category')); ?>">
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1  mt-1 editBtn" href="#" data-toggle="modal"
                              ...
                              data-status="<?php echo e($category->status); ?>" data-icon="<?php echo e($category->icon); ?>"
                              data-language_id="<?php echo e($category->language_id); ?>"
                            ...
                            <form class="deleteForm d-inline-block"
                              action="<?php echo e(route('admin.listing_specification.delete_category', ['id' => $category->id])); ?>"
                              method="post">
                              <?php echo csrf_field(); ?>
  ...
  <?php echo $__env->make('admin.listing.category.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

  
  <?php echo $__env->make('admin.listing.category.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/listing/category/index.blade.php ENDPATH**/ ?>