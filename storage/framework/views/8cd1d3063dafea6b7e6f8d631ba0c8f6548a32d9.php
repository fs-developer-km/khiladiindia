        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxEditForm" action="<?php echo e(route('vendor.update_password')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('vendors.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/frontend/vendor/auth/change-password.blade.php ENDPATH**/ ?>