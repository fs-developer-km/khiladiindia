  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="<?php echo e(route('admin.payment_gateways.store_offline_gateway')); ?>"
          method="POST">
          <?php echo csrf_field(); ?>
          <div class="row">
            <div class="col-lg-12">
...
<?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/payment-gateways/offline-gateways/create.blade.php ENDPATH**/ ?>