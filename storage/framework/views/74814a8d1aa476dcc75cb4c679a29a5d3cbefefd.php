        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <a href="<?php echo e(route('admin.announcement_popups.select_popup_type')); ?>"
                class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> <?php echo e(__('Add Popup')); ?></a>

              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="<?php echo e(route('admin.announcement_popups.bulk_delete_popup')); ?>">
                    ...
                    <tbody>
                      <?php $__currentLoopData = $popups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            <img src="<?php echo e(asset('assets/img/popup-samples/' . $popup->type . '.jpg')); ?>"
                              alt="popup type image" class="pt-4" width="55">
                            <p class="mt-1 text-muted"><?php echo e(__('Type') . ' - ' . $popup->type); ?></p>
                          </td>
                          <td><?php echo e($popup->name); ?></td>
                          <td>
                            <img src="<?php echo e(asset('assets/img/popups/' . $popup->image)); ?>" alt="popup image"
                              width="55">
                          </td>
                          <td>
                            <form id="statusForm-<?php echo e($popup->id); ?>" class="d-inline-block"
                              action="<?php echo e(route('admin.announcement_popups.update_popup_status', ['id' => $popup->id])); ?>"
                              method="post">
                              <?php echo csrf_field(); ?>
                              <select
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm  mt-1 mr-1"
                              href="<?php echo e(route('admin.announcement_popups.edit_popup', ['id' => $popup->id])); ?>">
                            ...
                            <form class="deleteForm d-inline-block"
                              action="<?php echo e(route('admin.announcement_popups.delete_popup', ['id' => $popup->id])); ?>"
                              method="post">
                              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u978586496/domains/kineticsage.com/public_html/khiladiindia/resources/views/admin/popup/index.blade.php ENDPATH**/ ?>