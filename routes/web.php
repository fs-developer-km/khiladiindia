...
Route::get('/jobs', [\App\Http\Controllers\FrontEnd\JobController::class, 'index'])->name('frontend.jobs.index');
Route::get('/jobs/{id}', [\App\Http\Controllers\FrontEnd\JobController::class, 'show'])->name('frontend.jobs.show');
  ...
  Route::prefix('/product')->middleware(['shop.status'])->group(function () {
    ...
    Route::get('user/signup', [UserController::class, 'showRegisterForm'])->name('user.signup');
...
Route::prefix('/user')->middleware(['guest:web', 'change.lang'])->group(function () {
 Route::prefix('/login')->group(function () {
    ...
    // OTP routes
    Route::post('/send_otp', 'FrontEnd\UserController@sendOTP')->name('user.send_otp');
    Route::post('/verify_otp', 'FrontEnd\UserController@verifyOTP')->name('user.verify_otp');
  });
