...
Route::prefix('vendor')->middleware('change.lang')->group(function () {
 ...
 Route::post('/signup/submit', 'Vendor\VendorController@create')->name('vendor.signup_submit');
  Route::get('/login', 'Vendor\VendorController@login')->name('vendor.login');
    Route::post('/send-login-otp', 'Vendor\VendorController@sendLoginOtp')->name('vendor.send_login_otp');
    Route::post('/login/submit', 'Vendor\VendorController@loginWithOtp')->name('vendor.login_submit');
Route::post('/vendor/send-otp', 'Vendor\VendorController@sendOtp')->name('vendor.send_otp');
...
Route::prefix('vendor')->middleware('auth:vendor', 'Demo', 'Deactive', 'email.verify')->group(function () {
  Route::get('/job-posting/create', [App\Http\Controllers\Vendor\JobPostingController::class, 'create'])->name('vendor.job_posting.create');
    Route::post('/job-posting/store', [App\Http\Controllers\Vendor\JobPostingController::class, 'store'])->name('vendor.job_posting.store');
    Route::get('/job-posting/listing', [App\Http\Controllers\Vendor\JobPostingController::class, 'listing'])->name('vendor.job_posting.listing');
    Route::get('/job-posting/edit/{id}', [App\Http\Controllers\Vendor\JobPostingController::class, 'edit'])->name('vendor.job_posting.edit');
    Route::post('/job-posting/update/{id}', [App\Http\Controllers\Vendor\JobPostingController::class, 'update'])->name('vendor.job_posting.update');
    Route::delete('/job-posting/delete/{id}', [App\Http\Controllers\Vendor\JobPostingController::class, 'destroy'])->name('vendor.job_posting.delete');
