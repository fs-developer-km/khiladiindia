...
use App\Http\Controllers\Admin\CategoryIconController;
/*
|--------------------------------------------------------------------------
| Admin Panel Routes
|--------------------------------------------------------------------------
...
Route::prefix('/admin')->middleware('auth:admin', 'Demo')->group(function () {
  ...
  Route::resource('category_icons', CategoryIconController::class);
  Route::resource('trending_categories', TrendingCategoryController::class);
