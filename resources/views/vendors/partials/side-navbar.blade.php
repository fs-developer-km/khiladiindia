...
<li
  class="nav-item @if (
      ...
      request()->routeIs('vendor.job_posting.listing')  {{-- new route --}}
  ) active @endif">
  ...
  <div id="listingManagement"
    ...
    <ul class="nav nav-collapse">
      ...
      {{-- New Job Posting --}}
      <li class="{{ request()->routeIs('vendor.job_posting.create') ? 'active' : '' }}">
        <a href="{{ route('vendor.job_posting.create', ['language' => $defaultLang->code]) }}">
          <span class="sub-item">Add Job Posting</span>
        </a>
      </li>

      <li class="{{ request()->routeIs('vendor.job_posting.listing') ? 'active' : '' }}">
        <a href="{{ route('vendor.job_posting.listing', ['language' => $defaultLang->code]) }}">
