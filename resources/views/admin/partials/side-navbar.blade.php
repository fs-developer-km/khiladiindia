            ...
            <div id="messages"
              ...
              <ul class="nav nav-collapse">
                ...
                <li class="{{ request()->routeIs('admin.listing.messages') ? 'active' : '' }}">
                  <a href="{{ route('admin.listing.messages', ['language' => $defaultLang->code]) }}">
...
active @endif
 ...
 <li
            ...
            <div id="admin"
              ...
              <ul class="nav nav-collapse">
           <li class="{{ request()->routeIs('category_icons.*') ? 'active' : '' }}">
  <a href="{{ route('category_icons.index') }}">
    <span class="sub-item">Category Icons</span>
              ...
              <li class="{{ request()->routeIs('admin.trending_categories.*') ? 'active' : '' }}">
    <a href="{{ route('trending_categories.index') }}">
